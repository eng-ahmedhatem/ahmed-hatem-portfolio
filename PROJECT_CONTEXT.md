...
متابعة الهيرو: تكبير مساحة الصورة/AH من 4 إلى 5 أعمدة على الكمبيوتر وزيادتها على الهاتف. ارتفاع الهيرو الأدنى هو `100svh` ناقص ارتفاع الهيدر وحدوده، مع تمدد طبيعي على الهاتف أو عند زيادة المحتوى بدل قصّه. مجموعة النصوص متوسطة رأسيًا؛ تأثير كتابة من Motion يكشف السطور باتجاه اللغة مع مؤشر قصير، دون تقسيم الحروف العربية أو تغيير نص H1 المرسل من الخادم. تعطيل الكشف والمؤشر في reduced motion. نجحت lint/typecheck/build والاختبارات الـ14، مع فحص السطرين وعدم overflow باللغتين على المقاسات الستة.
