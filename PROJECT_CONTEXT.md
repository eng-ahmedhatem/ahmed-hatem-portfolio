...
تحسينات الهوم والإدارة (2026-09-22): `HeroAmbient` يوزّع 8 عناصر SVG على مساحة الهيرو (5 على الهاتف)، بتحريك عنصرين في كل دورة وبمؤقّت واحد قابل للإلغاء، مع إيقاف الحركة خارج المشهد أو عند إخفاء التبويب واحترام reduced motion. قسم الآراء يستخدم كاروسيل native scroll-snap مع الأسهم والنقاط وHome/End واتجاه RTL، بلا autoplay؛ رأي واحد لا يعرض أدوات تنقل، والقسم الفارغ يبقى مخفيًا. إزالة حقول مخطط البناء القديم من محرر الهوم فقط، مع إبقاء payload/schema القديمين ونقل `blueprint.liveLabel` إلى «النص أسفل صورة الهيرو». لا migrations ولا بيانات آراء مزروعة. تمت مراجعة الكاروسيل وحقول المحرر بصفحة اختبار محلية دون حفظ في Supabase، ثم أزيلت الصفحة قبل بناء الإنتاج. نجحت lint/typecheck/build والاختبارات الـ16. التحقق من reduced motion في الكود وCSS وليس بمحاكاة إعداد النظام. طلب المالك رفع هذه الحزمة إلى GitHub؛ افحص Git history وremote لتأكيد حالة الرفع، ولا تفترض اكتمال نشر Vercel.
...
تم التحقق أيضًا من نسخة الإنتاج المحلية بعد تحسينات الكاروسيل: فتح الهوم AR/EN، إعادة التحميل وفتح قائمة الهاتف وتبديل اللغة، وفحص overflow عند 1440/1280/1024/768/430/390 دون أخطاء JavaScript. لم يُختبر حفظ CMS الحقيقي في هذه الجولة؛ تعديل الحقول اختُبر على payload محلي معزول.
